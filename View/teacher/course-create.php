...
<div class="container mx-auto p-6 mt-10">
    ...
    <div class="max-w-3xl mx-auto  bg-white  rounded  p-6  shadow-md ">
        ...
        <form action="#" method="post">
            ...
            <div class="mb-4">
                <label for="courseTitle" class="text-gray-700 mb-1  block  font-medium  ">Course Title </label>
                <input type="text" id="courseTitle" name="courseTitle" class="border border-gray-400 focus:border-purple-600  focus:outline-none rounded p-2 w-full" />
            </div>
            <!-- Input 2 Category Selector-->
            <div class="mb-4">
                <label for="category" class="text-gray-700 block  font-medium  mb-2">Category </label>
                <select id="category" name="category" class="border rounded py-2  focus:border-purple-600 text-gray-500 cursor-pointer  appearance-none   w-full   focus:outline-none px-4 pr-8">
                ...
                <div class="mb-4" id="selectContainer">
                    ...
                    <select id="courseType" name="courseType" class="border rounded py-2 focus:border-purple-600 text-gray-500 cursor-pointer appearance-none w-full focus:outline-none px-4 pr-8">
            ...
            <div class="mb-4">
                ...
                <input type="file" class=" w-full rounded  p-2  focus:outline-none border border-gray-400    focus:border-purple-600" />
            </div>

            <!-- input 4 Desctiption TextArea  -->
            <div class="mb-4">
                <label for="courseDescription" class="text-gray-700 block font-medium mb-1"> Description </label>
                <textarea id="courseDescription" name="courseDescription" class="w-full p-2 rounded border  border-gray-400  focus:border-purple-600 focus:outline-none" rows="6"></textarea>
            </div>
    ...
    document.getElementById('courseType').addEventListener('change', function (e) {
        ...
        if (courseType == 1) {
            ...
            <div class="mb-4" id="videoUrl">
                ...
                <input type="text" name="videoUrl" class="border border-gray-400 focus:border-purple-600 focus:outline-none rounded p-2 w-full" />
            </div>
        `);
            ...
            courseDescription.insertAdjacentHTML('afterend', `
           <textarea id="myMarkdown"></textarea>
        `);
